      ...
      <div className="space-y-4 p-6 lg:p-8 max-w-3xl">
        <Section title="Product statement">
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            explainable analysis, trusted document retrieval, and human-controlled incident
            response to protect mission-critical digital infrastructure.
          </p>
        </Section>

        <Section title="Phase 1 — what is shipped">
          <ul className="list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
            <li>Synthetic mission-network data generator with daily traffic cycles, baselines, and configurable fault injection.</li>
            <li>Transparent statistical scoring engine: rolling means, z-scores, weighted risk composition, root-cause ranking.</li>
            <li>Live Mission Overview, Network Topology, Devices list and detail, Predictions, Predictive Intelligence, Sustainability Impact.</li>
        ...
        <Section title="Planned phases">
          <ul className="list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
            <li>Authentication, role-based access (Operator, Manager, Security, Admin, Auditor).</li>
            ...
            <li>Persistent storage on Lovable Cloud for documents, incidents, audit trail, and user-uploaded telemetry.</li>
            <li>Labelled evaluation runs with real precision, recall, ROC-AUC against an evaluation dataset.</li>
          </ul>
        </Section>
