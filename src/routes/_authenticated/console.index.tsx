...
export const Route = createFileRoute("/_authenticated/console/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Live mission overview: fleet health, predicted risks, telemetry trends.",
      },
    ],
  }),
      ...
      <div className="space-y-6 p-6 lg:p-8">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
          <StatCard
            ...
            value={summary.total}
            sub={`${summary.total - summary.offline} reporting`}
          />
          ...
          <StatCard
            ...
            sub="risk ≥ 45%"
            tone={summary.predicted > 0 ? "warning" : "healthy"}
          />
          <StatCard
            ...
            sub="0–100"
            tone={
              summary.avgHealth >= 80 ? "healthy" : summary.avgHealth >= 60 ? "warning" : "critical"
            }
          />
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Section
            ...
            action={
              <Link to="/console/devices" className="text-xs text-primary hover:underline">
                View all →
              </Link>
            }
          >
