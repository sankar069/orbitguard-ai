...
export function StatCard({
  label, value, sub, tone = "default", mono = true,
}: { label: string; value: ReactNode; sub?: ReactNode; tone?: "default" | "healthy" | "warning" | "critical" | "primary"; mono?: boolean }) {
  const toneClass = {
  ...
  return (
    <div className="surface-panel p-4">
      ...
      <div className={`mt-1.5 font-display text-2xl font-semibold ${mono ? "tabular-nums" : ""} ${toneClass}`}>
        {value}
      </div>
